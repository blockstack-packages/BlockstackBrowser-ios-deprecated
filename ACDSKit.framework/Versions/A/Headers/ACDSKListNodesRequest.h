 ...
 */
@interface ACDSKListNodesRequest : ACDSKRequest

/**
 (optional) Filters on the nodes to include. Basic filter syntax is property:value. Examples of simple filters include @"kind:FILE" (for files), @"isRoot:true" (for the root node), and @"contentProperties.contentType:image*" (for nodes of any image content type). See the SDK guide for more options and information.
 */
